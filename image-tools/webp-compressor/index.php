...
<div class="container py-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">WebP Compressor</li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-body">
                    <h1 class="h3 mb-4 text-center">WebP Image Compressor</h1>
                    
                    <div class="text-center mb-4">
                        <i class="fas fa-file-image fa-3x text-danger mb-3"></i>
                        <p class="text-muted">Convert and compress your images to WebP format</p>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="custom-file-drop-area" id="dropArea">
                            ...
                            <div class="text-center p-4">
                                ...
                                <p class="mb-0">Drag & drop any image here or</p>
                    ...
                    <div id="previewArea" style="display: none;">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <h6 class="mb-3">Compressed WebP</h6>
                        ...
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-success" id="downloadBtn">
                                <i class="fas fa-download me-2"></i>Download WebP Image
                            </button>
                        </div>
                    </div>

                    <div class="alert alert-info mt-4">
                        <h6 class="alert-heading"><i class="fas fa-info-circle me-2"></i>About WebP Format</h6>
                        <p class="mb-0">WebP is a modern image format that provides superior lossless and lossy compression for images on the web. WebP images are typically 25-35% smaller than comparable JPEG images at equivalent visual quality.</p>
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function convertToWebP(file) {
        try {
            ...
            // Display WebP image and size
            compressedPreview.src = webpDataUrl;
            ...
            alert('Error converting image to WebP. Please try again.');
        }
    }

    async function handleQualityChange() {
        if (fileInput.files.length > 0) {
            await convertToWebP(fileInput.files[0]);
        }
    }
    ...
    downloadBtn.addEventListener('click', () => {
        ...
        link.download = 'compressed_' + newName;
